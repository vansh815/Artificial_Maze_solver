...
def moves(map, row, col,directions_matrix):
    ...
    for i in final_filtered:
        if (i[0] == row+1 and i[1] == col):
            directions_matrix[row+1][col]= directions_matrix[row][col] + "D"
        elif (i[0] == row-1 and i[1] == col):
            directions_matrix[row-1][col] = directions_matrix[row][col] + "U"
        elif (i[0] == row and i[1] == col+1):
            directions_matrix[row][col+1] = directions_matrix[row][col] + "R"
        elif (i[0] == row and i[1] == col-1):
            directions_matrix[row][col-1] = directions_matrix[row][col] + "L"
